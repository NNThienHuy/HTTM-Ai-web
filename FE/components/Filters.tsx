...
const Filters = () => {
  ...
  return (
    <div>
      <h3 className="text-2xl mb-2">Lọc</h3>
      <div className="divider"></div>
      <div className="flex flex-col gap-y-1">
        <h3 className="text-xl mb-2">Mặt hàng</h3>
        <div className="form-control">
          <label className="cursor-pointer flex items-center">
            <input
              ...
              className="checkbox"
            />
            <span className="label-text text-lg ml-2 text-black">Có hàng</span>
          </label>
        </div>
      ...
      <div>
        <h3 className="text-xl mb-2">Mức nhỏ nhất:</h3>
        <input
          type="range"
          min={0}
          max="5"
