    ...
    <>
      <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-black sm:text-5xl">Không tìm thấy trang</h1>
          <p className="mt-6 text-base leading-7 text-black">Xin lỗi, chúng tôi không thể tìm thấy trang bạn đang tìm kiếm.</p>
